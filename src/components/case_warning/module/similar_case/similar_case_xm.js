...
class SimilarCaseXm extends Component {
    ...
    return (
      <div className="similar_case">
        ...
        <ul className="pane_title">
          ...
          {/*>*/}
            {/*<i></i><b>法</b><b className="blue">信</b>推送*/}
          {/*</li>*/}
          {/*<li*/}
        ...
        <div className="pane_content">
          ...
          {this.state.pane_active === 0 ? <div className="page_div">
            <Pagination
              showSizeChanger
              showQuickJumper
              pageSizeOptions={['5','10','15','20']}
              pageSize={this.$store.state.similarCasePager.page_size}
              onShowSizeChange={(current, pageSize) => {
                this.$store.state.similarCasePager.page = 1;
                this.$store.state.similarCasePager.page_size = pageSize;
                const obj = Object.assign(form, { page: 1 , page_size: pageSize })
                changeForm(obj);
              }}
              onChange={(currentPage) => {
                this.$store.state.similarCasePager.page = currentPage;
                const obj = Object.assign(form, { page: currentPage , page_size: 5 });
                changeForm(obj);
              }}
              total={total}
              current={this.$store.state.similarCasePager.page}
            />
          </div> : null}
        </div>
      </div>
